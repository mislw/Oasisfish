...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.details.summary',
    kind: 'list',
    scope: 'session',
    summary: 'Feature summaries shown above selected tool details.',
    doc: 'Feature summaries shown above selected tool details.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  {
    key: 'conversation.session.header.progress',
    kind: 'list',
    scope: 'session',
    summary: 'Full-width progress strip below the title row.',
    doc: 'Full-width progress strip below the title row.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-desktop-update DesktopUpdateSection id \'app-updates\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Toolbox region selected by the sidebar mode control.',
    doc: 'Toolbox region selected by the sidebar mode control.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-game-toolbox ToolboxPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, image_generate, read, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-tool), so it exists while that entry is mounted',
    occupants: [
      'client-ui-attachment ImageGenerateResult key \'image_generate\'',
