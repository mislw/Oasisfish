...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-oasis-workflow OasisUiLauncherButton id \'oasis-ui-workflow\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Session metrics and other compact readings at the bottom of the Conversation column.',
    doc: 'Session metrics and other compact readings at the bottom of the Conversation column.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.status\', () => ctx.slots.register(\n      { name: \'conversation.status\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-wallpaper-engine-onboarding WallpaperOnboarding id \'wallpaper-engine-setup\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-oasis-workflow OasisUiWorkflowOverlay id \'oasis-ui-workflow\'',
