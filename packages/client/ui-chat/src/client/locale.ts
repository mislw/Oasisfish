...
export const zh = {
  ...
  'stats.liveTurn': '本轮 ~{tokens} tok',
  'stats.liveTurnAria': '本轮约 {tokens} tokens',
  'stats.todayTokens': '今日 {tokens} tok',
  'stats.todayTokensCost': '今日 {tokens} tok · {cost}',
  ...
  'stats.dialog.estimatedCost': '预计费用区间',
  'stats.dialog.unpricedRequests': '未计价请求',
  'stats.dialog.todayTitle': '今日用量',
  'stats.dialog.turns': '对话轮次',
  'stats.dialog.requests': '模型请求',
  'stats.dialog.latestRequest': '最近请求用量',
  'stats.dialog.latestRequestCost': '最近请求预计费用',
  'stats.dialog.failedSessions': '未读取会话',
...
export const en = {
  ...
  'stats.estimatedCost': '≈{cost}',
  'stats.liveTurn': 'Turn ~{tokens} tok',
  'stats.liveTurnAria': 'About {tokens} tokens in the current turn',
  'stats.todayTokens': 'Today {tokens} tok',
  'stats.todayTokensCost': 'Today {tokens} tok · {cost}',
  ...
  'stats.dialog.estimatedCost': 'Estimated cost range',
  'stats.dialog.unpricedRequests': 'Unpriced requests',
  'stats.dialog.todayTitle': 'Today usage',
  'stats.dialog.turns': 'Turns',
  'stats.dialog.requests': 'Model requests',
  'stats.dialog.latestRequest': 'Latest request usage',
  'stats.dialog.latestRequestCost': 'Latest request estimated cost',
  'stats.dialog.failedSessions': 'Unreadable sessions',
