...
AppFrame keeps the local Oasisfish seascape mounted below every column. Sidebar and details surfaces use translucent theme-token fills so the same scene remains visible across blank, conversation, toolbox, and settings states.
