...
| [`desktop-wallpaper-engine`](desktop-wallpaper-engine/README.md) | Optional Desktop Wallpaper Engine layer over the ordinary Web bundles | mounts the upstream integration and first-run onboarding |
