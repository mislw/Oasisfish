...
[skill（技能）能力族](../../packages/skill) 包含指令 Service Definition（[dsh-skill](../../packages/skill/skill)，`ctx.skills`）、本地 Service Provider（[dsh-skill-filesystem](../../packages/skill/skill-filesystem)）、可选的随包徽章提供方（[dsh-skill-badge](../../packages/skill/skill-badge)）、指令 Consumer（[dsh-tool-skill](../../packages/skill/tool-skill)），以及已声明语料搜索 Service Definition（[dsh-skill-search](../../packages/skill/skill-search)，`ctx.skillSearch`）。指令注册表在宿主层与各 scope 层之间合并提供方目录；提供方贡献本地或随包 skill；Consumer 拥有初始目录、替换目录和面向模型的 `skill` 工具。搜索注册表先解析同一个胜出 skill，再为显式语料声明选择提供方。skill 是可选指令而非会话事件，因此其词汇定义在此处而非 [core.md](core.zh.md)。

源码：[`packages/skill/skill/src/index.ts`](../../packages/skill/skill/src/index.ts)、[`packages/skill/skill-filesystem/src/index.ts`](../../packages/skill/skill-filesystem/src/index.ts)、[`packages/skill/skill-badge/src/index.ts`](../../packages/skill/skill-badge/src/index.ts)、[`packages/skill/skill-search/src/index.ts`](../../packages/skill/skill-search/src/index.ts) 与 [`packages/skill/tool-skill/src/index.ts`](../../packages/skill/tool-skill/src/index.ts)。
