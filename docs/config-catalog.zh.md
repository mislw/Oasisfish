...
需要：`agentDefaultModel` · `agents` · `attachments` · `fileUploads` · `llm` · `sessions` · `sessionProjections` · `sessionQuery` · `tokenMeter` · `typert` · `workspaceRegistry`
...
来源：[`packages/llm/llm-circuit-breaker/src/index.ts:27`](../packages/llm/llm-circuit-breaker/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-oasis-workflow` — 需要 `systemPrompt`（[`packages/client/ui-oasis-workflow/src/index.ts`](../packages/client/ui-oasis-workflow/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-wallpaper-engine-onboarding`（[`packages/client/ui-wallpaper-engine-onboarding/src/index.ts`](../packages/client/ui-wallpaper-engine-onboarding/src/index.ts)）
...
- `@deepseek-ai/dsh-desktop-wallpaper-engine`（[`packages/bundle/desktop-wallpaper-engine/src/index.ts`](../packages/bundle/desktop-wallpaper-engine/src/index.ts)）
