...
- `apps/desktop/resources/bundled-skills/` — upstream-owned Skill payloads copied byte-for-byte into Desktop runtime resources; their Markdown is product data, not repository documentation.
