...
> 文档ID: 193 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/193)

> 更新: 2025-06-19 11:33:40

**涉及API/标识符:** `ReceiveBeginPlay`, `UGCBackPackSystem.AddItem`, `UGCPlayerController`, `UGCPlayerController:ReceiveBeginPlay`
...
> 文档ID: 186 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/186)

> 更新: 2025-06-19 11:33:40

**涉及API/标识符:** `Equippable`, `SkillArchetypes`, `SkillEntryConfigs`, `StaticMesh`, `UAESkillManager`
...
> 文档ID: 188 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/188)

> 更新: 2025-06-19 11:33:40

**涉及API/标识符:** `BP_Grenade_Shoulei_Weapon`, `BP_ThrowComponent`, `EffectScale`, `EliteProjectile`, `ItemHandle`, `PickupWrapper`, `ProjectileMesh`, `ProjGrenade_BP`, `RangeScale`, `ReceiveProjectileExplodedEvent`, `Sphere`, `StaticMesh`, `WeaponClass`
...
> 文档ID: 187 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/187)

> 更新: 2025-06-19 11:33:40

**涉及API/标识符:** `BP_Rifle_M416`, `CrossHair`, `CrossHairData`, `HUDOwner`, `IsSpreadEnable`, `OnWeaponDrawHUDDelegate`, `PartDamage`, `ShootWeaponEntity`, `UE.LoadObject`, `UGCPlayerControllerSystem.EnableBulletTrackEffect`, `UL`, `VL`, `WeaponClass`, `WeaponHudWidget`
...
> 文档ID: 185 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/185)

> 新增: 2026-05-25 17:27:33

**涉及API/标识符:** `Lua`, `SkillConfig`, `SkillTriggerEvent`
...
> 文档ID: 194 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/194)

> 更新: 2025-06-19 11:33:40

**涉及API/标识符:** `DropItemConfig`, `DropItemGroup`, `Monster`, `RandomItem`, `RewardBox`, `UGCDropItemMgr.SpawnItems`
