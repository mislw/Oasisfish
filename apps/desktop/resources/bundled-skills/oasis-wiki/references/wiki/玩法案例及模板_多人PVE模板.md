...
> 文档ID: 20196 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20196)

> 更新: 2025-07-25 19:44:29

**涉及API/标识符:** `Beginplay`, `LuaExecute`, `LuaExecuteWithFinish`, `UGCGameMode`, `UGCGameMode.lua`, `UGCGameSystem.GetAllPlayerController`, `UGCGameSystem.GetPlayerControllerByPlayerKey`, `UGCGameSystem.GetUGCResourcesFullPath`, `UGCGameSystem.IsServer`, `UGCLevelFlowSystem.EnableLevelFlow`, `UGCLevelFlowSystem.GetAllPlayerControllerInCurrentLevel`, `UGCLevelFlowSystem.GoToNextLevelForOnePlayer`, `UGCLevelFlowSystem.LevelAddScore`, `UGCLevelReward`, `UGCLevelReward.lua`, `UGCResetData`, `UGCResetData.lua`, `UGCSettlement`, `UGCSettlement.lua`, `UGCTimeOut.lua`
...
> 文档ID: 20371 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20371)

> 新增: 2026-05-14 15:45:27
...
> 文档ID: 20193 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20193)

> 新增: 2026-05-14 15:44:28
...
> 文档ID: 20375 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20375)

> 新增: 2026-05-14 15:45:37
...
> 文档ID: 20195 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20195)

> 新增: 2026-05-14 15:45:24

**涉及API/标识符:** `UGCDrop.uasset`, `UGCDropGroup.uasset`, `UGCGameModeConfig.uasset`, `UGCObject.uasset`, `UGCObjectMapping.uasset`, `UGCShop.uasset`
...
> 文档ID: 20190 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20190)

> 新增: 2026-05-14 15:44:10 | 更新: 2026-05-20 10:18:07
...
> 文档ID: 20191 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20191)

> 更新: 2025-07-25 19:44:30

**涉及API/标识符:** `UGCDropGroup.uasset`, `UGCGameModeConfig.uasset`, `UGCGameModeDetail.uasset`, `UGCObject.uasset`
...
> 文档ID: 20192 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20192)

> 更新: 2025-09-04 21:06:42
...
> 文档ID: 20197 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20197)

> 新增: 2026-05-14 15:44:16

**涉及API/标识符:** `UGC_Lobby031_01.UGC_Lobby031_01`, `UGCmap.UGCmap`
...
> 文档ID: 20194 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20194)

> 新增: 2026-05-14 15:44:30

**涉及API/标识符:** `UGCDrop.uasset`, `UGCDropGroup.uasset`
...
> 文档ID: 20372 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20372)

> 新增: 2026-05-14 15:45:35 | 更新: 2026-07-27 13:42:31

**涉及API/标识符:** `UGCAffixDetails`, `UGCEquippmentRandomAffix`, `UGCItemMapAffixId`
...
- ID：序列号，无需关注，没有重复即可。
- MutexExclusion：互斥类型，支持中文。后文随机配置的时候会说明该功能。这里只需要保证在使用了相同属性时这里配置一样的就行了。
...
- QuantityOfAffixs：只有在非被动技能，即为属性修改时生效。用于配置该词条的数值随机上下限。（如果装备最终出现未随机到词条，很有可能是这里上下弄反导致的）
...
- QuantityOfAffixs：配置该随机词条组需要随机多少个词条
...
如果该随机词条组IsRepeat为false，则在0中随机到的词条，后续在1中就不随机到相同 互斥类型 的词条。

>假设随机到的数量为1，随机到的词条为1014。因为1013,1012,1011与1014在 词条属性表-MutexExclusion 中配置的是相同互斥类型。后续在其他数组中就不会再随机到1013.1012.1011 词条。从而实现了假如随机到了橙色词条的攻击力加成，则后续不再出现紫蓝绿白等其他品质的攻击力词条。
...
> 文档ID: 20198 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20198)

> 新增: 2026-05-14 15:44:21

**涉及API/标识符:** `UGCDerivedAttributes.lua`, `UGCGlobalDamageCalculation.lua`, `UGCHero.uasset`
