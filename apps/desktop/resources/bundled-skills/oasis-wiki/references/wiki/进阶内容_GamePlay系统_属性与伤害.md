...
> 文档ID: 20099 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20099)

> 更新: 2026-03-06 17:12:53

**涉及API/标识符:** `ASTExtraBaseCharacter`, `Context`, `DamageContext`, `DamageContext.ResultTags`, `ExtraResult`, `GetCalculationResult`, `GetDamageTagsFromContext`, `GetDamageTypeFromContext`, `GetSourceMagnitudeFromContext`, `GetVictimFromContext`, `UGC.Damage`, `UGC.PlayerPawn`, `UGC_TakeDamageOverrideEvent`, `UGCAttributeSystem`, `UGCAttributeSystem.GetDamageTagsFromContext`, `UGCAttributeSystem.GetDamageTypeFromContext`, `UGCGameplayTagSystem.RequestGameplayTag`, `UGCGenericMessageSystem`, `UGCGenericMessageSystem.ListenObjectMessage`, `UGCGenericMessageSystem.Messages`, `UGCGenericMessageSystem.Messages.UGC.PlayerPawn.PostTakeDamage`, `UGCGenericMessageSystem.Messages.UGC.PlayerPawn.PreTakeDamage`, `UGCGenericMessageSystem.UnListenObjectMessage`
...
> 文档ID: 20216 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20216)

> 新增: 2026-07-31 17:56:20

**涉及API/标识符:** `Context`, `ExtraResult`, `GetCalculationResult`, `GetDamageTagsFromContext`, `GetSourceMagnitudeFromContext`, `GetVictimFromContext`, `RecoverGenericCharacterHealth`, `UGC.Damage`, `UGCAttributeSystem`, `UGCAttributeSystem.GetDamageTagsFromContext`, `UGCGameplayTagSystem.RequestGameplayTag`
...
![image.png](https://cgugc-video-test-1258633575.cos.ap-shanghai.myqcloud.com/wiki_picture/ZOgAZimage.png)
...
> 文档ID: 20169 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20169)

> 新增: 2026-07-31 17:56:16
...
![image.png](https://cgugc-video-test-1258633575.cos.ap-shanghai.myqcloud.com/wiki_picture/uE5tKimage.png)
...
> 文档ID: 20153 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20153)

> 更新: 2025-09-05 16:59:30
...
> 文档ID: 20159 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20159)

> 更新: 2025-06-25 18:11:03
...
> 文档ID: 20205 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20205)

> 新增: 2026-06-23 12:42:41

**涉及API/标识符:** `AdditiveSpeedValueWrapper`
...
|-|-|-|
|Health|角色的当前血量|[0, +∞)|
|HealthMax|角色的最大血量|[0, 100000000]|
|SkillCDRecoverRate|技能CD的恢复速率|[0, 100000000]|
|SignalHP|角色当前的信号量|[0, +∞)|
|SignalHPMax|角色的最大信号量|[0, 99999]|
|voiceCheckDis|角色检测周围声音的最大距离，影响 [小地图可视化音效](https://developer.gp.qq.com/wikieditor/#/catalog/20202) 的图标显示效果|[0.01, 100000000]|
|Breath|角色的当前呼吸值|[-100000000, 100000000]|
|AdditiveSpeedValueWrapper|角色移动时额外叠加的移速倍率，影响走路、冲刺、游泳等所有移动行为<br>``角色最终移动速度 = 基础移动速度 * (UGC移速倍率 + 额外移速倍率)``|[-100000000, 100000000]|
|EnergyCurrent|角色的当前能量值|[0, +∞)|
|UGCGeneralMoveSpeedScale|UGC移速倍率，与 ``AdditiveSpeedValueWrapper`` 共同影响角色的移动速度|[0.01, 100000000]|
|RescueOtherDurationRate|角色救援队友时，救援所需时间的倍率|[0, 100000000]|
|JumpCountLimit|角色连续跳跃的次数上限|[0, 100000000]|
|JumpZSpeed|角色进行跳跃时的初速度|[0, 100000000]|
|FallingDamageRatio|角色受到跌落伤害的倍率系数|[-100000000, 100000000]|
...
> 文档ID: 20246 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20246)

> 更新: 2025-11-17 22:11:01
...
> 文档ID: 20098 | [官网原文](https://developer.gp.qq.com/wikieditor/#/catalog/20098)

> 新增: 2026-05-20 10:17:20

**涉及API/标识符:** `AttrModifyComp`, `FGameMagnitudeContext`, `number`, `TestAttribute`, `UGCAttributeSystem`, `UGCAttributeSystem.GetGameAttributeValue`, `UGCGameSystem.UGCRequire`, `UGCGenericCharacterSystem.GetHealth`, `UGCGenericCharacterSystem.IsGenericCharacter`, `UGCNativeGameAttributeType.Character_Health`
