...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmProviderProbeRequest: 'llm-streaming.md',
  LlmProviderProbeResult: 'llm-streaming.md',
  ...
  GenerateImageRequest: 'attachment.md',
  GeneratedImage: 'attachment.md',
  GeneratedImageBatch: 'attachment.md',
  ...
  MemoryAddRequest: 'memory.md',
  MemoryContext: 'memory.md',
  MemoryError: 'memory.md',
  MemoryErrorCode: 'memory.md',
  MemoryId: 'memory.md',
  MemoryProvider: 'memory.md',
  MemoryRecord: 'memory.md',
  MemoryRemoteAddRequest: 'memory.md',
  MemoryRemoteContext: 'memory.md',
  MemoryRemoteListRequest: 'memory.md',
  MemoryRemoteRemoveRequest: 'memory.md',
  MemoryRemoteSetEnabledRequest: 'memory.md',
  MemoryRemoteUpdateRequest: 'memory.md',
  MemoryRemoveRequest: 'memory.md',
  MemoryRemoveResult: 'memory.md',
  MemoryScope: 'memory.md',
  MemorySnapshot: 'memory.md',
  ...
  SkillSearchOptions: 'skills.md',
  SkillSearchProvider: 'skills.md',
  SkillSearchProviderControl: 'skills.md',
  SkillSearchRequest: 'skills.md',
  SkillSearchResult: 'skills.md',
