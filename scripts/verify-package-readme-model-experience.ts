...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/skill/skill-search-local': { kind: 'indirect', reason: 'The local retrieval provider delegates model rendering to dsh-tool-skill-search.' },
  ...
  'packages/client/ui-settings-memory': { kind: 'none', reason: 'Browser-side memory management surface; registers nothing model-facing.' },
  ...
  'packages/client/ui-desktop-update': { kind: 'none', reason: 'Browser-side desktop update settings; update state and commands never enter model requests or session logs.' },
  ...
  'packages/memory/memory': { kind: 'indirect', reason: 'The service interface delegates model rendering to dsh-tool-memory.' },
  ...
  'packages/skill/skill-search': { kind: 'indirect', reason: 'The search registry delegates model rendering to a tool Consumer.' },
