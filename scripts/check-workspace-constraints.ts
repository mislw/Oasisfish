...
/** App workspaces used only to assemble non-npm products or deploy closures. */
const nonReleaseAppDirectories = new Set([
  'apps/desktop',
...
function checkWorkspace({ dir, manifest }: WorkspaceManifest): string[] {
  ...
  } else if (releaseMemberDirectory.test(dir) && !nonReleaseAppDirectories.has(dir)) {
  ...
  if (dir.startsWith('apps/')
    && !nonReleaseAppDirectories.has(dir)
